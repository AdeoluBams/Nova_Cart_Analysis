...
## Project Overview
This is an end-to-end Analysis into the sales and operation performance of the e-commerc "Nova_Cart". By looking into varoius aspect of the company data, we seek to identify trends, sales drive, brand limitation, Retention Metrics, Customer drop_off rate, drop_off drivers and overall performance of the business.

## Data Sources
Nova_Cart_Data: The primary dataset used for this analysis is the "Nova_Cart_data.csv" file, containing detailed information about the sales made by the company. 
